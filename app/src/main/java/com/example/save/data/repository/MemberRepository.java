...
public class MemberRepository {
    ...
    private MemberRepository(Context context) {
        ...
        maxLoanDuration = prefs.getInt("max_loan_duration", 12);
    ...
    public void addMember(Member member, MemberRegistrationCallback callback) {
        ...
        // Create API request with empty OTP/password (backend will generate it)
        com.example.save.data.network.MemberRegistrationRequest request = new com.example.save.data.network.MemberRegistrationRequest(
                ...
                member.getEmail(),
                member.getPhone(),
                "", // OTP/password is now generated by the backend
                member.getRole(),
                "" 
        );
        ...
        apiService.createMember(request).enqueue(new retrofit2.Callback<com.example.save.data.network.MemberRegistrationResponse>() {
            @Override
            public void onResponse(retrofit2.Call<com.example.save.data.network.MemberRegistrationResponse> call,
                    retrofit2.Response<com.example.save.data.network.MemberRegistrationResponse> response) {
                if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                    String generatedOtp = response.body().getOtp();
                    member.setPassword(generatedOtp); // Assign generated OTP back to the member object
                    ...
                    executor.execute(() -> {
                        try {
                            ...
                            if (callback != null) {
                                new android.os.Handler(android.os.Looper.getMainLooper())
                                        .post(() -> callback.onResult(true, "Member created successfully", generatedOtp));
                            }
                        } catch (Exception e) {
                            if (callback != null) {
                                new android.os.Handler(android.os.Looper.getMainLooper())
                                        .post(() -> callback.onResult(false, e.getMessage(), null));
                            }
                        }
                    });
                } else {
                    ...
                    if (callback != null) {
                        new android.os.Handler(android.os.Looper.getMainLooper())
                                .post(() -> callback.onResult(false, finalErrorMsg, null));
                    }
                }
            }

            @Override
            public void onFailure(retrofit2.Call<com.example.save.data.network.MemberRegistrationResponse> call, Throwable t) {
                // Network error
                if (callback != null) {
                    new android.os.Handler(android.os.Looper.getMainLooper())
                            .post(() -> callback.onResult(false, "Network error: " + t.getMessage(), null));
                }
            }
        });
    }
    ...
    /**
     * Resends an invitation email to a member via the backend.
     *
     * @param member   The member to receive the email.
     * @param callback Callback to handle the response.
     */
    public void sendMemberInvite(Member member, MemberAddCallback callback) {
        if (member == null || member.getId() == null) {
            if (callback != null)
                callback.onResult(false, "Invalid member or identifier");
            return;
        }
        ...
        apiService.sendMemberInvite(member.getId())
                .enqueue(new retrofit2.Callback<com.example.save.data.network.ApiResponse>() {
                    @Override
                    public void onResponse(retrofit2.Call<com.example.save.data.network.ApiResponse> call,
                            retrofit2.Response<com.example.save.data.network.ApiResponse> response) {
                        if (response.isSuccessful() && response.body() != null) {
                            if (callback != null) {
                                callback.onResult(response.body().isSuccess(), response.body().getMessage());
                            }
                        } else {
                            String errorMsg = "Failed to resend invitation";
                            try {
                                if (response.errorBody() != null) {
                                    org.json.JSONObject jsonObject = new org.json.JSONObject(response.errorBody().string());
                                    errorMsg = jsonObject.optString("detail", jsonObject.optString("message", errorMsg));
                                }
                            } catch (Exception e) {
                            }
                            if (callback != null)
    ...
    /**
     * Resets the member's password using an OTP and the reset-password API.
     */
    public void resetPassword(String email, String newPassword, PasswordChangeCallback callback) {
        ...
        apiService.resetPassword(request).enqueue(
                new retrofit2.Callback<com.example.save.data.network.ApiResponse>() {
                    ...
                    public void onResponse(
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            if (callback != null)
                                callback.onResult(false, "Failed to reset password");
                        }
                    }
    ...
    @Deprecated
    // Shortfall resolution logic is now implemented below using the backend API.
    ...
    public void setMaxLoanAmount(double amount) {
        // NOTE: This is now managed via backend SystemConfig.
    ...
    /**
     * Resolves a member's shortfall by calling the backend API.
     *
     ...
     * @param callback      Callback to handle the response.
     */
    public void resolveShortfall(String memberId, double amount, String paymentMethod, ApiResponseCallback callback) {
        com.example.save.data.network.ShortfallResolutionRequest request = new com.example.save.data.network.ShortfallResolutionRequest(
                amount, paymentMethod);

        com.example.save.data.network.ApiService apiService = com.example.save.data.network.RetrofitClient
                .getClient(appContext).create(com.example.save.data.network.ApiService.class);

        apiService.resolveShortfall(memberId, request).enqueue(
                new retrofit2.Callback<com.example.save.data.network.ApiResponse>() {
                    @Override
                    public void onResponse(
                            retrofit2.Call<com.example.save.data.network.ApiResponse> call,
                        ...
                        if (response.isSuccessful() && response.body() != null) {
                            ...
                            com.example.save.utils.ApiErrorHandler.handleResponse(appContext, response);
                            if (callback != null)
                                callback.onResult(false, "Failed to resolve shortfall");
                        }
                    }
        ...
        apiService.getSystemConfig().enqueue(new retrofit2.Callback<com.example.save.data.models.SystemConfig>() {
            ...
            public void onResponse(retrofit2.Call<com.example.save.data.models.SystemConfig> call,
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    contributionTarget = config.getContributionAmount();
                    double latePenaltyRateInternal = config.getLatePenaltyRate();
                    maxLoanDuration = config.getMaxLoanDuration();
                    ...
                    prefs.edit()
                            ...
                            .putLong("contribution_target", Double.doubleToRawLongBits(contributionTarget))
                            .putLong("late_penalty_rate", Double.doubleToRawLongBits(latePenaltyRateInternal))
