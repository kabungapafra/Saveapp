...
public class Otp extends Fragment {
    ...
    public static Otp newInstance(String name, String phone, String email, String password) {
    ...
    private void verifyOtp() {
        ...
        // Body: { "name": name, "phone": "+256" + phone, "email": email, "password": password, "otp": otp }
