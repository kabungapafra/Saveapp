...
public final class ActivityProfileInfoBinding implements ViewBinding {
  ...
  private ActivityProfileInfoBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView tvGroupName, @NonNull TextView tvMemberSince, @NonNull TextView tvUserEmail,
      @NonNull TextView tvUserName, @NonNull TextView tvUserPhone, @NonNull TextView tvUserRole) {
  ...
  public static ActivityProfileInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProfileInfoBinding((ConstraintLayout) rootView, backButton, headerLayout,
          tvGroupName, tvMemberSince, tvUserEmail, tvUserName, tvUserPhone, tvUserRole);
    }
