...
public final class ActivityAdminregBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityAdminregBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdminregBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_adminreg, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdminregBinding bind(@NonNull View rootView) {
