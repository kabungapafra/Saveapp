...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull CardView rootView, @NonNull CardView cardNotification,
      @NonNull ImageView ivIcon, @NonNull View readIndicator, @NonNull TextView tvMessage,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.readIndicator;
      View readIndicator = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemNotificationBinding((CardView) rootView, cardNotification, ivIcon,
          readIndicator, tvMessage, tvTime, tvTitle);
    }
